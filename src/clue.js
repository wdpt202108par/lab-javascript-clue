...
function revealMystery() {
  var finalReveal=pickMystery()
  return `${finalReveal.suspect.firstName} ${finalReveal.suspect.lastName} killed Mr. Boddy using the ${finalReveal.weapon.name} in the ${finalReveal.room.name}!`
};
